...
module "ecs" {
  ...
  master_key_arn                     = module.ssm.master_key_arn
  app_key_arn                        = module.ssm.app_key_arn
  passport_private_key_arn           = module.ssm.passport_private_key_arn
  passport_public_key_arn            = module.ssm.passport_public_key_arn
  env                                = var.env
...
module "ssm" {
  ...
  app_key                 = var.app_key
  passport_private_key    = var.passport_private_key
  passport_public_key     = var.passport_public_key
}
