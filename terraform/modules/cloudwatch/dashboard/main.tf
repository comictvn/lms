   ...
   "widgets":[
      ...
      },
      {
         ...
         "properties":{
            ...
            "stacked":false,
            "metrics":[
               [ "AWS/ECS", "MemoryUtilization", "ServiceName", "${var.name}_worker", "ClusterName", "${var.name}", { "label": "Minimum", "stat": "Minimum", "color": "#2ca02c" } ],
               [ "...", { "stat": "Average", "label": "Average" } ],
               [ "...", { "color": "#1f77b4", "stat": "Maximum", "label": "Maximum" } ]
            ],
            "region":"${var.region}",
            "period":300,
            "title":"Memory utilization worker"
         }
      },
      {
         "type":"metric",
         ...
         "properties":{
            ...
            "stacked":false,
            "metrics":[
               [ "AWS/ECS", "CPUUtilization", "ServiceName", "${var.name}_worker", "ClusterName", "${var.name}", { "label": "Maximum", "stat": "Maximum" } ],
               [ "...", { "stat": "Average", "label": "Average" } ],
               [ "...", { "stat": "Minimum", "label": "Minimum" } ]
            ],
            "region":"${var.region}",
            "period":300,
            "title":"CPU utilization worker"
         }
      },
      {
         "type":"metric",
